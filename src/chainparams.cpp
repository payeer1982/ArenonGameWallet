...
public:
    CMainParams() {
        ...
        const char* pszTimestamp = "Alonso el mayor masternode que existio";
        ...
        vout.resize(1);
        vout[0].SetEmpty();
        CTransaction txNew(1, 1527491362, vin, vout, 0);
        ...
        vSeeds.push_back(CDNSSeedData("1", "85.53.81.75"));
        vSeeds.push_back(CDNSSeedData("0", "192.168.1.103"));

        convertSeeds(vFixedSeeds, pnSeed, ARRAYLEN(pnSeed), nDefaultPort);
        //vFixedSeeds.clear("209.250.248.103", "209.250.248.103");
        //vSeeds.clear("209.250.248.103", "209.250.248.103");
